...
int main(int argc, char**argv)
{
    ...
    *  /data/interfaces-state/interface[1]
    *
    *  The second interface will be maintained by other client.
    */

   strcpy (dataStoreName, "urn:ietf:params:xml:ns:yang:ietf-interfaces/interfaces");
