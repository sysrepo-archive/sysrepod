...
client_SRD/mainSRDClient.o: client_SRD/mainSRDClient.c
	$(CC) -I/usr/include/libxml2 -I. -g -o client_SRD/mainSRDClient.o -c client_SRD/mainSRDClient.c
...
client_SRD/mainOpDStoreMgmtClient.o: client_SRD/mainOpDStoreMgmtClient.c
	$(CC) -I/usr/include/libxml2 -I. -g -o client_SRD/mainOpDStoreMgmtClient.o -c client_SRD/mainOpDStoreMgmtClient.c
...
client_SRD/mainOpDStoreSubTree1.o: client_SRD/mainOpDStoreSubTree1.c
	$(CC) -I/usr/include/libxml2 -I. -g -o client_SRD/mainOpDStoreSubTree1.o -c client_SRD/mainOpDStoreSubTree1.c
...
client_SRD/mainOpDStoreSubTree2.o: client_SRD/mainOpDStoreSubTree2.c
	$(CC) -I/usr/include/libxml2 -I. -g -o client_SRD/mainOpDStoreSubTree2.o -c client_SRD/mainOpDStoreSubTree2.c
...
client_SRD/mainOpDStoreGetSubTree.o: client_SRD/mainOpDStoreGetSubTree.c
	$(CC) -I/usr/include/libxml2 -I. -g -o client_SRD/mainOpDStoreGetSubTree.o -c client_SRD/mainOpDStoreGetSubTree.c
...
client_SRD/mainHugeTest.o: client_SRD/mainHugeTest.c
	$(CC) -I/usr/include/libxml2 -I. -g -o client_SRD/mainHugeTest.o -c client_SRD/mainHugeTest.c
	
server/genHuge: server/genHugeXML.c
	$(CC) -g -o server/genHuge server/genHugeXML.c
	
srd.o: srd.c srd.h
	$(CC) -I/usr/include/libxml2 -g -c srd.c
